...
/*
JiraConnectSubscriptionsApiService Subscribe a namespace to a JiraConnectInstallation
...
func (a *JiraConnectSubscriptionsApiService) PostApiV4IntegrationsJiraConnectSubscriptions(ctx context.Context, postApiV4IntegrationsJiraConnectSubscriptions PostApiV4IntegrationsJiraConnectSubscriptions) (ApiEntitiesBasicSuccess, *http.Response, error) {
	var (
		...
		localVarReturnValue ApiEntitiesBasicSuccess
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v4/integrations/jira_connect/subscriptions"
	...
	// body params
	localVarPostBody = &postApiV4IntegrationsJiraConnectSubscriptions
