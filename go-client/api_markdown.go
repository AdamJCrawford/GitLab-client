...
/*
MarkdownApiService Render an arbitrary Markdown document
...
func (a *MarkdownApiService) PostApiV4Markdown(ctx context.Context, postApiV4Markdown PostApiV4Markdown) (ApiEntitiesMarkdown, *http.Response, error) {
	var (
		...
		localVarReturnValue ApiEntitiesMarkdown
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v4/markdown"
	...
	// body params
	localVarPostBody = &postApiV4Markdown
